...
COPY --from=module-build --chown=1000:1000 /module/app/target/math-service-0.0.1-SNAPSHOT.jar ./math-service-0.0.1-SNAPSHOT.jar

ENTRYPOINT ["java", "-jar", "math-service-0.0.1-SNAPSHOT.jar"]
